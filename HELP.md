...
* The original package name 'lk.rusl.cricket.cricket-attendance-backend' is invalid and this project uses 'lk.rusl.cricket.cricket_attendance_backend' instead.
